...
export class AreaService {
  private readonly _areas = signal<AreaResponse[]>([]);
  private readonly _lookup = signal<AreaLookupResponse[]>([]);
...
> {
  ...
  getArea(
    id: number
  ): Observable<ApiResponse<AreaResponse>> {
    return this.http.get<ApiResponse<AreaResponse>>(
  ...
  updateShipping(
    ...
    return this.http.put<ApiResponse<AreaResponse>>(
